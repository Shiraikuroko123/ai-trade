...
AI Trade `v0.7.0` defines and tests a broker boundary but intentionally ships no broker-specific implementation. Installing an adapter does not unlock live trading.
