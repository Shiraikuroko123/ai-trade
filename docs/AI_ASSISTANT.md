...
AI Trade v0.10.0 includes an optional K-line assistant for reviewing completed market bars. It is always `research_only`: it cannot produce an order, change a target portfolio, unlock a broker gate, or promise a return.
