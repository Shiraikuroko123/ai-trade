...
COMMANDS: dict[str, tuple[str, ...]] = {
    ...
    "refresh-intraday": ("intraday-refresh",),
    "refresh-valuation": ("valuation-refresh",),
    "refresh-fundamentals": ("fundamentals-refresh",),
    "refresh-disclosures": ("disclosures-refresh",),
    "refresh-order-book": ("order-book-refresh",),
    "refresh-news": ("news-refresh",),
    "backtest": ("backtest",),
