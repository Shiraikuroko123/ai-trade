...
- The release baseline is the `v0.15.0` local workstation, including the professional read-only market view, auditable universe screen, independent Yahoo/Tushare reference routes, and separately identified official, third-party, fundamental, valuation, and Level-1 depth evidence.
