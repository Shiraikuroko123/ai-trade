...
- The release baseline is the `v0.13.0` local workstation, including the professional read-only market view, auditable universe screen, and independent Yahoo OHLCV reference audit.
