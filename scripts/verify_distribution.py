...
WHEEL_REQUIRED = {
    ...
    "ai_trade/research_archive.py",
    "ai_trade/research_digest.py",
    "ai_trade/research_digest_cloud.py",
    "ai_trade/research_epochs.py",
    "ai_trade/research_journal.py",
    "ai_trade/monitoring.py",
    "ai_trade/numeric.py",
    "ai_trade/notification_channels.py",
    "ai_trade/notification_delivery.py",
    "ai_trade/assistant/__init__.py",
    "ai_trade/assistant/debate.py",
    "ai_trade/assistant/engine.py",
    "ai_trade/assistant/features.py",
    "ai_trade/assistant/governance.py",
    "ai_trade/assistant/provider.py",
    "ai_trade/assistant/store.py",
    "ai_trade/factor_lab/__init__.py",
    "ai_trade/factor_lab/custom.py",
    "ai_trade/factor_lab/engine.py",
    "ai_trade/factor_lab/expression.py",
    "ai_trade/factor_lab/library.py",
    "ai_trade/factor_lab/schema.py",
    "ai_trade/factor_lab/store.py",
    "ai_trade/hypothesis_lab/__init__.py",
    "ai_trade/hypothesis_lab/engine.py",
    "ai_trade/hypothesis_lab/nested.py",
    "ai_trade/hypothesis_lab/run_schema.py",
    "ai_trade/hypothesis_lab/runner.py",
    "ai_trade/hypothesis_lab/schema.py",
    "ai_trade/hypothesis_lab/store.py",
    "ai_trade/hypothesis_lab/sweep.py",
    "ai_trade/research_report.py",
    "ai_trade/pipeline_cli.py",
    "ai_trade/feature_store/__init__.py",
    "ai_trade/feature_store/builder.py",
    "ai_trade/feature_store/forward.py",
    "ai_trade/feature_store/labels.py",
    "ai_trade/feature_store/provenance.py",
    "ai_trade/feature_store/schema.py",
    "ai_trade/feature_store/store.py",
    "ai_trade/model_lab/__init__.py",
    "ai_trade/model_lab/engine.py",
    "ai_trade/model_lab/gbdt.py",
    "ai_trade/model_lab/library.py",
    "ai_trade/model_lab/schema.py",
    "ai_trade/model_lab/store.py",
    ...
    "ai_trade/data/sentiment.py",
    "ai_trade/data/tushare.py",
    "ai_trade/data/tushare_reference.py",
...
SDIST_REQUIRED = {
    ...
    "docs/HYPOTHESIS_LAB.md",
    "docs/JQDATA.md",
    "docs/FORWARD_EVIDENCE.md",
    ...
    "scripts/run_daily_monitor.ps1",
    "scripts/install_archive_task.ps1",
    "scripts/run_daily_archive.ps1",
    ...
    "src/ai_trade/research_archive.py",
    "src/ai_trade/research_digest.py",
    "src/ai_trade/research_digest_cloud.py",
    "src/ai_trade/research_epochs.py",
    "src/ai_trade/monitoring.py",
    "src/ai_trade/numeric.py",
    "src/ai_trade/research_journal.py",
    "src/ai_trade/assistant/__init__.py",
    "src/ai_trade/assistant/debate.py",
    "src/ai_trade/assistant/engine.py",
    "src/ai_trade/assistant/features.py",
    "src/ai_trade/assistant/governance.py",
    "src/ai_trade/assistant/provider.py",
    "src/ai_trade/assistant/store.py",
    "src/ai_trade/factor_lab/__init__.py",
    "src/ai_trade/factor_lab/custom.py",
    "src/ai_trade/factor_lab/engine.py",
    "src/ai_trade/factor_lab/expression.py",
    "src/ai_trade/factor_lab/library.py",
    "src/ai_trade/factor_lab/schema.py",
    "src/ai_trade/factor_lab/store.py",
    "src/ai_trade/hypothesis_lab/__init__.py",
    "src/ai_trade/hypothesis_lab/engine.py",
    "src/ai_trade/hypothesis_lab/nested.py",
    "src/ai_trade/hypothesis_lab/run_schema.py",
    "src/ai_trade/hypothesis_lab/runner.py",
    "src/ai_trade/hypothesis_lab/schema.py",
    "src/ai_trade/hypothesis_lab/store.py",
    "src/ai_trade/hypothesis_lab/sweep.py",
    "src/ai_trade/research_report.py",
    "src/ai_trade/pipeline_cli.py",
    "src/ai_trade/feature_store/__init__.py",
    "src/ai_trade/feature_store/builder.py",
    "src/ai_trade/feature_store/forward.py",
    "src/ai_trade/feature_store/labels.py",
    "src/ai_trade/feature_store/provenance.py",
    "src/ai_trade/feature_store/schema.py",
    "src/ai_trade/feature_store/store.py",
    "src/ai_trade/model_lab/__init__.py",
    "src/ai_trade/model_lab/engine.py",
    "src/ai_trade/model_lab/gbdt.py",
    "src/ai_trade/model_lab/library.py",
    "src/ai_trade/model_lab/schema.py",
    "src/ai_trade/model_lab/store.py",
